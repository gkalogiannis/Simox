...
namespace GraspStudio
{
    ...
    */
    ...
    public:
	    ...
	    \param prefered_contact_points	
        */
        GenericGraspPlanner(VirtualRobot::GraspSetPtr graspSet, GraspStudio::GraspQualityMeasurePtr graspQuality, GraspStudio::ApproachMovementGeneratorPtr approach, float minQuality = 0.0f, bool forceClosure = true, int prefered_contact_points = 2, float frictionCoef = 0.25f);
